defmodule B2Web.Live.Game.Figure do
  ...
  alias B2Web.Live.Game.Helpers.TextFigureFor

  def render(assigns) do
    IO.inspect(assigns, label: :render_figure)
  ...
  defp graphical(assigns = %{graphical: false}) do
    ~H"""
    <div class="textual" id="drawing">
    <pre>
     <%= TextFigureFor.figure_for(@tally.turns_left) %>
    </pre>
    </div>
    """
  end

  defp graphical(assigns = %{graphical: true}) do
    ~H"""
      <svg id="drawing"
